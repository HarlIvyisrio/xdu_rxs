package com.xdurxs.rxs.auth.runner;
...
import com.xdurxs.rxs.auth.domain.dataobject.PermissionDO;
import com.xdurxs.rxs.auth.domain.dataobject.RoleDO;
import com.xdurxs.rxs.auth.domain.dataobject.RolePermissionDO;
import com.xdurxs.rxs.auth.domain.mapper.PermissionDOMapper;
import com.xdurxs.rxs.auth.domain.mapper.RoleDOMapper;
import com.xdurxs.rxs.auth.domain.mapper.RolePermissionDOMapper;
        ...
        try {
            ...
            if (CollUtil.isNotEmpty(roleDOS)) {
                ...
                roleIdPermissionDOMap.forEach((roleId, permission) -> {
                    ...
                    //List<PermissionDO> localPermission = permission;
                    redisTemplate.opsForValue().set(key, JsonUtil.toJsonString(permission));
                });
            }
